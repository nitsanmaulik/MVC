...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['title'], $_POST['description'], $_POST['assigned_to'])) {
    ...
    if ($stmt->execute()) {
        header("Location: team_leader_dashboard.php?success=Task Updated");
        exit();
    } else {
...
<html lang="en">
<head>
    <title>Update Task (Team Leader)</title>
    <link rel="stylesheet" href="../Assets/CSS/dashboard.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css">
</head>
<body>
    <div class="container mt-5">
        <h2 class="text-center">Edit Task (Team Leader)</h2>
        <form action="update_task_team_leader.php" method="POST">
            ...
            <a href="team_leader_dashboard.php" class="btn btn-secondary w-100 mt-2">Cancel</a>
        </form>
    </div>
</body>
</html>
